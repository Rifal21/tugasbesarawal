...
<html lang="en">
  <head>
    ...
    <title>Halaman Admin | Kelola Produk</title>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid m-auto">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-center text-gray-800">Kelola Product</h1>
            <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-4">Tambah Produk</button>
          </div>
          <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>Processor Intel Core i9</td>
                <td><img src="../img/produk/1.png" width="50px" alt=""></td>
                <td>Rp. 12.999.999</td>
              ...
              <tr>
                <th scope="row">2</th>
                <td>Motherboard</td>
                <td><img src="../img/produk/2.png" width="50px" alt=""></td>
                <td>Rp. 899.000</td>
                <td><a href="edit.html" class="badge badge-warning">Edit</a> | <a href="hapus.html" class="badge badge-danger">Delete</a></td>
              </tr>
              <tr>
                <th scope="row">3</th>
                <td>Gaming Chair</td>
                <td><img src="../img/produk/3.png" width="50px" alt=""></td>
                <td>Rp. 14.000.000</td>
                <td><a href="edit.html" class="badge badge-warning">Edit</a> | <a href="hapus.html" class="badge badge-danger">Delete</a></td>
              </tr>
            </tbody>
