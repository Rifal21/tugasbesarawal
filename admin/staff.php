...
<html lang="en">
  <head>
    ...
    <title>Halaman Admin | Staff Administrasi</title>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid m-auto">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-center text-gray-800">Kelola Staff Administrasi</h1>
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>2003010025@unper.ac.id</td>
                <td>087749323752</td>
                <td>Kp. Baru , Rt.04/Rw.05 , Desa Ciawi, Kecamatan Ciawi, Kabupaten Tasikmalaya</td>
                <td>Giantzord</td>
              ...
              <tr>
                <th scope="row">2</th>
                <td>Ega Mulyana</td>
                <td>20030100..@unper.ac.id</td>
                <td>088888888888</td>
                <td>Gobras Tasikmalaya</td>
                <td>Incognito</td>
                <td><a href="edit.html" class="badge badge-warning">Edit</a> | <a href="hapus.html" class="badge badge-danger">Delete</a></td>
              </tr>
              <tr>
                ...
                <td>20030100..@unper.ac.id</td>
                <td>000000000000</td>
                <td>Simpang Lima Tasikmalaya</td>
                <td>Jipe</td>
                <td><a href="edit.html" class="badge badge-warning">Edit</a> | <a href="hapus.html" class="badge badge-danger">Delete</a></td>
              </tr>
