...
<html lang="en">
  <head>
    ...
    <title>Halaman Admin | Kelola Jasa</title>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid m-auto">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-center text-gray-800">Kelola Services</h1>
            <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-4">Tambah Jasa</button>
          </div>
          <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td>...</td>
                <td>Rp.</td>
                <td>Menerima jasa instalasi software dan Sistem Operasi</td>
              ...
              <tr>
                ...
                <td>...</td>
                <td>Rp.</td>
                <td>Menerima jasa perakitan komputer dan pemasangan wifi</td>
                <td><a href="edit.html" class="badge badge-warning">Edit</a> | <a href="hapus.html" class="badge badge-danger">Delete</a></td>
              </tr>
              <tr>
                <th scope="row">3</th>
                ...
                <td>...</td>
                <td>Rp.</td>
                <td>Beli games keren dengan harga murah dan terpercaya</td>
                <td><a href="edit.html" class="badge badge-warning">Edit</a> | <a href="hapus.html" class="badge badge-danger">Delete</a></td>
              </tr>
            </tbody>
          </table>
